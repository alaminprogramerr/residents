...
import axios from 'axios';
 ...
 class RepaireInProgress  extends React .Component{
     constructor(){
         super()
         this.state={ 
            EstimateProgress:[]
     ...
     componentDidMount(){
        axios.get('/api/getAllInProgress')       
        .then(res=>{
          console.log(res)
          this.setState({
            EstimateProgress:res.data.client
          })
        })
     }
     doRepaire=(id)=>{
        axios.get('/api/doRepaired/'+id)
        .then(res=>{
          window.location='/repairedone'
        })
        .catch(err=>{
          console.log(err)
        })
        ...
        render(){
            ...
            return(
                <div className="ml-3 mr-3 mt-5 mb-5 ">
                    ...
                    {this.state.EstimateProgress.length==0?
                    ...
                    <Card small className="mb-4">
                      ...
                      <CardBody className="p-0 pb-3">
                        <table className="table mb-0">
                          ...
                          <tbody>
                              {this.state.EstimateProgress.map(( singleItem, i) =>{
                                  return(
                                    ...
                                    <tr key={i}>
                                        ...
                                        <div class="dropdown">
                                                ...
                                                <a class="dropdown-item" href="#"  data-toggle="modal" onClick={this.doRepaire.bind(this, singleItem._id)} data-target="#exampleModal"  >Repaire Done</a>
...
export default RepaireInProgress
